...
DISABLE_SOUND_MOBILE = false,
 ...
 STATE_LOADING = 0, STATE_MENU = 1, STATE_HELP = 1, STATE_GAME = 3,
  ON_MOUSE_DOWN = 0, ON_MOUSE_UP = 1, ON_MOUSE_OVER = 2, ON_MOUSE_OUT = 3, ON_DRAG_START = 4, ON_DRAG_END = 5,
   GRID_COLS, GRID_ROWS, GRID_SIZE, GRID_OFFSET_X, GRID_OFFSET_Y, 
   TIME_SHOW_NEW_BLOCK, NUM_COLORS, BLOCK_SPEED, BLOCK_DOWN_SPEED, BLOCK_EMPTY = 0, BLOCK_LINE = 3,
    STATE_MOVE = 1, STATE_LINE = 2, STATE_FALL = 3, NUM_LIVES = 3, 
    BUT_LEFT_X = 40, BUT_LEFT_Y = 400, BUT_RIGHT_X = 280, BUT_RIGHT_Y = 400;
